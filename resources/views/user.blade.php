    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-left">
                        <a href="{{route('user.download')}}" class="btn btn-danger" style="color:white;">PDF <i
                                class="icon-file-pdf ml-2"></i></a>
                        <a href="{{route('user.export')}}" class="btn btn-success" style="color:white;">Excel <i
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i>
                        Cancel</button>
                    <form method="post" id="modal-delete-user" action="">
                        @csrf
                        @method('DELETE')
...
@section("jsDataTable")
<script src="{{asset('js/tables/datatables_user.js')}}"></script>
@endsection